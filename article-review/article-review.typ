...
In the context of this project, our team has learned how to conduct a Systematic Literature Review (SLR), design and execute a formal experiment, and critically analyze empirical results within the context of existing scientific research. We have gained invaluable, hands-on experience with service mesh technologies and their performance implications in microservices architectures—skills that are directly applicable to our future careers in software engineering and cloud computing.

Moreover, this subject has reinforced the absolute necessity of methodological rigor and scientific integrity in informatics. Critiquing the reference article allowed us to see firsthand how subtle inconsistencies in experimental design, poor variable control, and a lack of validity threat analysis can compromise the reliability of conclusions. 

Thanks to the foundations laid by this course, we are now fully equipped to design our own studies with a strict focus on controlling confounding variables, ensuring reproducibility, and transparently processing and reporting data. This experience has successfully bridged academic research principles with practical system engineering, fulfilling the core learning outcomes of our curriculum.
